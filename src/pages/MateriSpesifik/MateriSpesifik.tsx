const DetailMateri = () => {
    return (
        <section className="w-full px-4 py-10 max-w-4xl mx-auto">
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6 flex flex-row gap-6">

                <div className="flex flex-col gap-4 mb-6">
                    <img
                        src="https://via.placeholder.com/300x200?text=Gambar+1"
                        alt="proses hujan"
                        className="rounded-lg"
                    />
                    <img
                        src="https://via.placeholder.com/300x200?text=Gambar+2"
                        alt="proses hujan"
                        className="rounded-lg"
                    />
                    <img
                        src="https://via.placeholder.com/300x200?text=Gambar+3"
                        alt="proses hujan"
                        className="rounded-lg"
                    />
                </div>
