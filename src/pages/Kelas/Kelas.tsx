...
const dataKelas = [
  ...
  { nama: "Kelas 5", link: "5", bg: "/images/bg-kelas5.jpg", progress: 0 },
  ...
  { nama: "Kelas 11", link: "11", bg: "/images/bg-kelas11.jpg", progress: 0 },
    ...
    <section className="sm:ml-64">
      <div className="px-4 py-8 max-w-screen-xl mx-auto">
        ...
        {kelas === 'sd' || kelas  === 'smp' || kelas === 'sma' ? (
          ...
          <p className="text-center text-gray-500">Maaf, kelas tidak ditemukan</p>
        )}
      </div>
    </section>
  );
